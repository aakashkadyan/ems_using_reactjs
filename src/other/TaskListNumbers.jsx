  ...
  return (
    <div className='flex mt-10 justify-between gap-5 screen'>
        <div className='p-10 rounded-xl px-9-py-6 w-[45%] bg-red-400'>
            <h2 className='text-3xl text-white font-semibold'>{data.taskNumbers.newTask}</h2>
            <h3 className='text-xl text-white font-medium'>New Task</h3>
        </div>
        <div className='p-10 rounded-xl px-9-py-6 w-[45%] bg-green-400'>
            <h2 className='text-3xl text-white font-semibold'>{data.taskNumbers.active}</h2>
            <h3 className='text-xl text-white font-medium'>Accepted Task</h3>
        </div>
        <div className='p-10 rounded-xl px-9-py-6 w-[45%] bg-yellow-400'>
            <h2 className='text-3xl text-white font-semibold'>{data.taskNumbers.failed}</h2>
            <h3 className='text-xl text-white font-medium'>Failed Task</h3>
        </div>
        <div className='p-10 rounded-xl px-9-py-6 w-[45%] bg-pink-400'>
            <h2 className='text-3xl text-white font-semibold'>{data.taskNumbers.completedTask}</h2>
